...
public class App {
    ...
    // rappel : on n'a pas encore vu les Stream (on reprendra la m̩thode plus tard)
    public static <T> List<T> filtragePredicatif(List<Predicate<T>> conditions, List<T> elements) {
        List<T> rtr = new ArrayList<>();
        // construction du pr̩dicat conjonctif
    ...
    // noter que doit ̻tre apr̬s aDEF (ou aDEF import̩)
    ...
    public static void question3() {
        ...
        afficheSiv2(ENTETE_TOUS, e -> true, a1, e -> {
            Double m = moyenne.apply(e);
            String ms = (m == null) ? "d̩faillant" : String.format("%.2f", m);
